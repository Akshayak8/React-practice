...
const Main = () => {
  const [currentPage, setCurrentPage] = useState("login"); // Initial state
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const options = {
        ...
        headers: {
          "X-RapidAPI-Key":
            "af7f453774msh468771ec6dbf256p14fc2cjsnd3be1a8ec9d1",
    ...
    <div>
      ...
      <div>
        ...
        {fetchedData && (
          <div>
            <h2>Fetched Data</h2>
            <pre>{JSON.stringify(fetchedData, null, 4)}</pre>
          </div>
        )}
      </div>
    </div>
